...
% subject = [7 112 113 121 75 107 79 82 118 76 115 117 119 120 105 78];
% subject = [7 112 113 114 75 107 79 82 118 76 115 117 119 120];
...
%         data_one = dlmread("clean_and_labeled_abs_main_result/"+id+"_tcr_s"+session+".txt");
%         data_one = data_one(1:3000, 2:21);
%         data = [data; data_one];
        data_one = dlmread("new_tcr_raw_data/"+id+"_tcr_s"+session+".txt");
    ...
    for session_id = 1:6
        ...
        filename = strcat("new_tcr_plateau_removed_data/tcr_subject_",string(subject_id),"_session_",string(session_id),".csv");
